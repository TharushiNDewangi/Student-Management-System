    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
             ...
             try{
                // DBUtil.DatabaseConnection.iud("insert into classroom_shedule(teacher-id,Subject,clasroom_id,Time_period,Day) values('"+jTextField5.getText()+"','"+jTextField4.getText()+"','"+jTextField6.getText()+"','"+jTextField3.getText()+"','"+jComboBox1.getSelectedItem().toString()+"')");
                  DBUtill.CreateDataBaseConnection.iud("insert into classroom_shedule(Time_period,Day,Subject,teacherid,clasroom_id) values('"+jTextField3.getText()+"','"+jComboBox1.getSelectedItem().toString()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"','"+jTextField6.getText()+"')"); 
...
try{
            DBUtill.CreateDataBaseConnection.iud("update classroom_shedule set Time_period='"+jTextField3.getText()+"',Day='"+jComboBox1.getSelectedItem().toString()+"',Subject='"+jTextField4.getText()+"',clasroom_id='"+jTextField6.getText()+"',teacherid='"+jTextField5.getText()+"' where shedule_id='"+jTextField2.getText()+"'");
    ...
    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
        ...
        try{
            ...
            ResultSet rs=DBUtill.CreateDataBaseConnection.search("select * from classroom_shedule where shedule_id='"+jTextField2.getText()+"'");
