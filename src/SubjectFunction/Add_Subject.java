...
public class Add_Subject extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        try{
            DBUtill.CreateDataBaseConnection.iud("update subject set idsubject='"+subjectId.getText()+"',name='"+name.getText()+"',description='"+description.getText()+"'where idsubject='"+searchBox.getText()+"'");
    ...
    private void searchBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBoxActionPerformed
        ...
        try{
            ...
            ResultSet rs= DBUtill.CreateDataBaseConnection.search("select * from subject where idsubject='"+searchBox.getText()+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            DBUtill.CreateDataBaseConnection.iud("insert into subject(idsubject,name,description) values('"+subjectId.getText()+"','"+name.getText()+"','"+description.getText()+"')");
