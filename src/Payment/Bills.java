...
public class Bills extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bilid.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(date)
                        .addComponent(year))
                    .addComponent(month, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(incom, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel7)
                        .addGap(18, 18, 18)
                        .addComponent(searchfid, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(57, 57, 57)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
                            .addComponent(bilid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            DBUtill.CreateDataBaseConnection.iud("insert into bill (idbill,type,date,month,amount,year) values('"+bilid.getText()+"','"+type.getSelectedItem().toString()+"','"+date.getText()+"','"+month.getSelectedItem().toString()+"','"+amount.getText()+"','"+year.getText()+"')");
            JOptionPane.showMessageDialog(null, "added");
            DBUtill.CreateDataBaseConnection.iud("update income  set income=income-'"+amount.getText()+"' where idincome ='in1'");
	    DBUtill.CreateDataBaseConnection.iud("insert into inomeoutcome(month,outcome,year)values('"+month.getSelectedItem().toString()+"','"+amount.getText()+"','"+year.getText()+"')");//JOptionPane.showMessageDialog(null, "updated");	
			 //incom.setText(null);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try {
            DBUtill.CreateDataBaseConnection.iud("update bill set idbill='"+bilid.getText()+"',"
                    + "type='"+type.getSelectedItem().toString()+"',date='"+date.getText()+"',"
                    + "month='"+month.getSelectedItem().toString()+"',amount='"+amount.getText()+"',year='"+year.getText()+"'where idbill ='"+searchfid.getText()+"'");
    ...
    private void searchfidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchfidActionPerformed
        ...
        try
        {
            ResultSet rs = DBUtill.CreateDataBaseConnection.search("select * from bill where idbill='"+searchfid.getText()+"'");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        area.setText("**********************************************\n");
        area.setText(area.getText()+" 'Recept System' \n");
        area.setText(area.getText()+"**********************************************\n");
        area.setText(area.getText()+"bill number :"+bilid.getText()+"\n");
        area.setText(area.getText()+"bill trpe :"+type.getSelectedItem()+"\n");
        area.setText(area.getText()+"bill date :"+date.getText()+"\n");
        area.setText(area.getText()+"bill month :"+month.getSelectedItem()+"\n");
        area.setText(area.getText()+"bill amount :"+amount.getText()+"\n");
        area.setText(area.getText()+"bill year :"+year.getText()+"\n");
        
        
        //type='"+type.getSelectedItem().toString()+"',date='"+date.getText()+"',month='"+month.getSelectedItem()
        //.toString()+"',amount='"+amount.getText()+"',year='"+year.getText()+"'where idbill ='"+searchfid.getText()+"'");
...
//        String date = obj.toString();
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            CreateDataBaseConnection.iud("delete  from bill where idbill='"+searchfid.getText()+"'");
    ...
    private void bilidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_bilidKeyPressed
     

        // TODO add your handling code here:
    }//GEN-LAST:event_bilidKeyPressed

    private void yearKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_yearKeyPressed
 if (this.year.getText().trim().length() == 0) {
            //JOptionPane.showMessageDialog(null, "year must not be empty.", "Error", JOptionPane.ERROR_MESSAGE);
            evt.consume();
        }        // TODO add your handling code here:
